...
This repository implements the Short-Term Plasticity Neuron (STPN) in Jax, and tests it in bsuite benchmark. 
...
![stpn sweep](reports/standalone/images/stpn_sweep.png)
...
Below is the original bsuite readme.
________
